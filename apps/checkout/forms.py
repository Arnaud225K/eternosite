...
class OrderCreateForm(forms.ModelForm):
    ...
    name = forms.CharField(
        ...
        max_length=50, 
        required=False,
        error_messages={'required': 'Пожалуйста, введите ваш Ф.И.О.'},
    ...
    class Meta:
        model = Order
        fields = ['name', 'email', 'phone', 'comment', 'file', 'marketing_consent']
    ...
    def clean_phone(self):
        ...
        # On Normalise le '8' russe en '7'
        if cleaned_phone.startswith('8') and len(cleaned_phone) == 11:
            cleaned_phone = '7' + cleaned_phone[1:]

        # On Valide le format (doit commencer par 7 et avoir 11 chiffres)
