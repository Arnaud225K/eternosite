...
class ArticleCategory(models.Model):
    ...
    slug = models.SlugField("URL-ключ", max_length=100, unique=True, blank=True)
...
class Articles(models.Model):
    category = models.ForeignKey(ArticleCategory, verbose_name="Категория", on_delete=models.SET_NULL, null=True, blank=True, related_name="articles")
    order_number = models.PositiveIntegerField("Порядок", default=100)
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['category', 'is_hidden', '-date'], name='idx_articles_cat_hidden_date'),
            models.Index(fields=['is_hidden', 'is_show_main', '-date'], name='idx_articles_main_page'),
        ]
