...
//                 const newFiltersContainer = document.getElementById('filters-container');
//                 if(newFiltersContainer) {
//                     const title = newFiltersContainer.querySelector(".filters__title");
//                     const wrapper = newFiltersContainer.querySelector(".filters__wrapper");
//                     if (title && wrapper) {
//                         newFiltersContainer.classList.add("is-open");
//                         wrapper.style.maxHeight = wrapper.scrollHeight + "px";
//                         setTimeout(() => { wrapper.style.overflow = "visible"; }, 400);
//                     }
//                 }
//             }
//         } catch (error) {
...
//                     fetchAndUpdatePage(finalUrl, null, false); 
//                 }
//             }
//         }
//     });
