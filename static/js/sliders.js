(() => {
                    ...
                    void 0 !== n &&
                        ...
                        (l(e[r]) && l(i[r])
                            ? i[r].__swiper__
                                ...
                                : c(e[r], i[r])
                            : !l(e[r]) && l(i[r])
                              ? ((e[r] = {}), i[r].__swiper__ ? (e[r] = i[r]) : c(e[r], i[r]))
                              : (e[r] = i[r]));
                }
            }
        }
    ...
    var A = {
        ...
        updateSlides: function () {
            ...
            for (let i = 0; i < u; i += 1) {
                let r;
                if (
                    ((k = 0), c[i] && (r = c[i]), P && e.grid.updateSlide(i, r, c), !c[i] || "none" !== v(r, "display"))
                ) {
                    if ("auto" === s.slidesPerView) {
                        ...
                        if (
                            (a && (r.style.transform = "none"), o && (r.style.webkitTransform = "none"), s.roundLengths)
                        )
                            k = e.isHorizontal() ? w(r, "width", !0) : w(r, "height", !0);
                        else {
                            const e = t(n, "width"),
                                s = t(n, "padding-left"),
                                i = t(n, "padding-right"),
                        ...
                        (k = (n - (s.slidesPerView - 1) * E) / s.slidesPerView),
                            s.roundLengths && (k = Math.floor(k)),
                            c[i] && (c[i].style[e.getDirectionLabel("width")] = `${k}px`);
                    c[i] && (c[i].swiperSlideSize = k),
                        g.push(k),
                        s.centeredSlides
                            ? ((y = y + k / 2 + M / 2 + E),
                              0 === M && 0 !== i && (y = y - n / 2 - E),
            ...
            if (
                ...
                P && e.grid.updateWrapperSize(k, h),
                !s.centeredSlides)
            ) {
                const t = [];
            ...
            if (
                (Object.assign(e, { slides: c, snapGrid: h, slidesGrid: f, slidesSizesGrid: g }),
    ...
    var G = {
            slideTo: function (e, t, s, i, r) {
                ...
                if ((!T || !r) && ((m && -w === n.translate) || (!m && w === n.translate)))
                    return (
                ...
                if (o.cssMode) {
                    ...
                    if (0 === t)
                        ...
                        if (!n.support.smoothScroll)
                            return u({ swiper: n, targetPosition: s, side: e ? "left" : "top" }), !0;
                ...
                if (
                    (void 0 !== f &&
                        ...
                        "auto" === r.slidesPerView &&
                            ...
                            ((v = v - i.slidesPerViewDynamic("previous", !0) + 1), (v = Math.max(v, 0)))),
                    ...
                    (r = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10)),
                        t.centeredSlides
                            ...
                            : n > (l ? (e.slides.length - i) / 2 - (e.params.grid.rows - 1) : e.slides.length - i)
                              ? (e.loopFix(),
                                (n = e.getSlideIndex(m(s, `${o}[data-swiper-slide-index="${r}"]`)[0])),
                                a(() => {
                                    e.slideTo(n);
                                }))
                              : e.slideTo(n);
        ...
        _ = {
            loopCreate: function (e, t) {
                ...
                const o = i.slidesPerGroup * (a ? i.grid.rows : 1),
                    ...
                    c = (e) => {
                        for (let t = 0; t < e; t += 1) {
                            const e = s.isElement
                                ? f("swiper-slide", [i.slideBlankClass])
                                : f("div", [i.slideClass, i.slideBlankClass]);
                            s.slidesEl.append(e);
                        }
                    };
                l
            ...
            loopFix: function (e) {
                ...
                const { slides: c, allowSlidePrev: p, allowSlideNext: u, slidesEl: m, params: f } = d,
                    { centeredSlides: v, initialSlide: g } = f;
                ...
                "auto" === w
                    ...
                    : ((w = Math.ceil(parseFloat(f.slidesPerView, 10))), v && w % 2 == 0 && (w += 1));
                const S = f.slidesPerGroupAuto ? w : f.slidesPerGroup;
                let T = v ? Math.max(S, Math.ceil(w / 2)) : S;
                T % S !== 0 && (T += S - (T % S)), (T += f.loopAdditionalSlides), (d.loopedSlides = T);
                ...
                c.length < w + T || ("cards" === d.params.effect && c.length < w + 2 * T)
                    ...
                    : b &&
                      "row" === f.grid.fill &&
                      h("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
                const x = [],
                    E = [],
                    y = b ? Math.ceil(c.length / f.grid.rows) : c.length,
                    M = a && y - g < w && !v;
                let C = M ? g : d.activeIndex;
                void 0 === n ? (n = d.getSlideIndex(c.find((e) => e.classList.contains(f.slideActiveClass)))) : (C = n);
                const P = "next" === i || !i,
                    k = "prev" === i || !i;
                let L = 0,
                    I = 0;
                ...
                if (
                    ...
                    "cards" === d.params.effect &&
                        c.length < w + 2 * T &&
                        (E.includes(n) && E.splice(E.indexOf(n), 1), x.includes(n) && x.splice(x.indexOf(n), 1)),
                    k &&
                        x.forEach((e) => {
    ...
    function V(e) {
        ...
        p.matches(a.focusableElements) && ((w = !1), "SELECT" === p.nodeName && (a.isTouched = !1)),
            s.activeElement &&
                ...
                s.activeElement !== p &&
                ("mouse" === r.pointerType || ("mouse" !== r.pointerType && !p.matches(a.focusableElements))) &&
    ...
    function B(e) {
        ...
        if ("touchmove" === p.type) {
            if (((c = [...p.changedTouches].find((e) => e.identifier === r.touchId)), !c || c.identifier !== r.touchId))
                return;
        } else c = p;
        ...
        if (!s.allowTouchMove)
            return (
                ...
                void (
                    r.isTouched &&
                    (Object.assign(a, { startX: u, startY: m, currentX: u, currentY: m }), (r.touchStartTime = o()))
                )
            );
        ...
        n.oneWayMovement && ((v = Math.abs(v) * (l ? 1 : -1)), (g = Math.abs(g) * (l ? 1 : -1))),
            (a.diff = v),
            (v *= n.touchRatio),
            l && ((v = -v), (g = -g));
            ...
            v > 0
                ? (S &&
                  ...
                  r.currentTranslate > s.minTranslate() &&
                      ...
                      n.resistance &&
                          (r.currentTranslate =
                              s.minTranslate() - 1 + (-s.minTranslate() + r.startTranslate + v) ** x)))
                : v < 0 &&
                  (S &&
                      T &&
                      r.allowThresholdMove &&
                  ...
                  r.currentTranslate < s.maxTranslate() &&
                      ...
                      n.resistance &&
                          (r.currentTranslate =
                              s.maxTranslate() + 1 - (s.maxTranslate() - r.startTranslate - v) ** x))),
    ...
    function N(e) {
        ...
        if ((r.originalEvent && (r = r.originalEvent), "touchend" === r.type || "touchcancel" === r.type)) {
            if (((i = [...r.changedTouches].find((e) => e.identifier === s.touchId)), !i || i.identifier !== s.touchId))
                return;
        } else {
        ...
        for (let e = 0; e < c.length; e += e < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
            ...
            void 0 !== c[e + t]
                ? (f || (h >= c[e] && h < c[e + t])) && ((v = e), (g = c[e + t] - c[e]))
                : (f || h >= c[e]) && ((v = e), (g = c[c.length - 1] - c[c.length - 2]));
        }
        let w = null,
            S = null;
        n.rewind &&
            (t.isBeginning
                ? (S = n.virtual && n.virtual.enabled && t.virtual ? t.virtual.slides.length - 1 : t.slides.length - 1)
                : t.isEnd && (w = 0));
        const T = (h - c[v]) / g,
        ...
        if (m > n.longSwipesMs) {
            ...
            "next" === t.swipeDirection &&
                (T >= n.longSwipesRatio ? t.slideTo(n.rewind && t.isEnd ? w : v + b) : t.slideTo(v)),
            ...
            translate: {
                ...
                setTranslate: function (e, t) {
                    ...
                    s.isHorizontal() ? (l = i ? -e : e) : (d = e),
                        ...
                        r.cssMode
                            ? (n[s.isHorizontal() ? "scrollLeft" : "scrollTop"] = s.isHorizontal() ? -l : -d)
                            : r.virtualTranslate ||
                ...
                translateTo: function (e, t, s, i, r) {
                    ...
                    if (((c = i && e > l ? l : i && e < d ? d : e), n.updateProgress(c), a.cssMode)) {
                        ...
                        if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -c;
                            ...
                            if (!n.support.smoothScroll)
                                return u({ swiper: n, targetPosition: -c, side: e ? "left" : "top" }), !0;
            ...
            transition: {
                ...
                transitionEnd: function (e, t) {
                    ...
                    const s = this,
                        { params: i } = s;
                    (s.animating = !1),
                        i.cssMode || (s.setTransition(0), z({ swiper: s, runCallbacks: e, direction: t, step: "End" }));
                },
            },
            slide: G,
            loop: _,
                ...
                setBreakpoint: function () {
                    ...
                    m && !h
                        ...
                        : !m &&
                          ...
                          ((u.grid.fill && "column" === u.grid.fill) || (!u.grid.fill && "column" === r.grid.fill)) &&
    ...
    Object.keys(U).forEach((e) => {
        ...
        new J(".reviews__slider", {
            modules: [
                function (e) {
                    ...
                    function c() {
                        ...
                        let s = n(e.nextEl),
                            i = n(e.prevEl);
                        Object.assign(t.navigation, { nextEl: s, prevEl: i }), (s = S(s)), (i = S(i));
                        const r = (s, i) => {
            ...
            navigation: { nextEl: ".reviews__controls-right", prevEl: ".reviews__controls-left" },
        });
})();
