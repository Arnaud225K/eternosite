...
(() => {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        //         // Optionnel: si on clique sur un produit déjà au panier, aller au panier
        ...
        //         // Mettre à jour toutes les cartes du même produit sur la page
...
// --- ÉCOUTEUR DÉLÉGUÉ GLOBAL SUR document.body ---
        // Gère les actions sur les éléments qui peuvent être ajoutés dynamiquement (cartes produits)
        document.body.addEventListener('click', async function(event) {
            
            // --- Cible 1 : Bouton "Ajouter au panier" ---
            const addButton = event.target.closest('.addtocart');
            if (addButton) {
                event.preventDefault();
                const productCard = addButton.closest('.subcategory__product');
            ...
            // --- Cible 2 : Boutons +/- sur les cartes produits (NOUVEAU BLOC) ---
        ...
        // Délégation pour les changements manuels de quantité
